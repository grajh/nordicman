...
# Version: 2024.06.19
# Description: Python tool for reading and manipulating Nordic and
# several other earthquake bulletin or catalog formats. Useful methods
# for earthquake and phase filtering, writing output files, calculting
